...
namespace SisUvex.Consultas.Manifest.QueryPerManifest
{
    internal class ClsQueryPerManifest
    {
        ...
        string qryPresentationPerDay = @" SELECT
              man.id_manifest AS 'Manifiesto', 
              ...
              cns.v_nameConsignee AS 'Consignatario',
              man.v_factura AS 'Factura',
              man.v_facturaUuid AS 'Folio Fiscal',
              ...
              LEFT JOIN dbo.Pack_Grower AS gro ON gro.id_grower = man.id_grower
              LEFT JOIN dbo.Pack_Distributor AS dis ON dis.id_distributor = man.id_distributor  
              LEFT JOIN dbo.Pack_Consignee AS cns ON cns.id_consignee = man.id_consignee
