...
namespace SisUvex.Material.MaterialType
{
    internal class ClsMaterialType
    {
        ...
        {
            _frmCat ??= new FrmMaterialTypeCat();
            _frmCat.cls ??= this;
        ...
        public void OpenFrmAdd()
        {
            ...
            _frmAdd = new FrmMaterialTypeAdd();
            _frmAdd.cls = this;
        ...
        {
            EMaterialType addMaterialType = new();
            addMaterialType = SetMaterialTypeEntity();
            var result = addMaterialType.AddProcedure();
            IsAddUpdate = result.Item1;
            idAddModify = result.Item2;
        }
        public void ModifyProcedure()
        {
            EMaterialType modifyMaterialType = new();
            modifyMaterialType = SetMaterialTypeEntity();
            var result = modifyMaterialType.ModifyProcedure();
