...
namespace SisUvex.Catalogos.Metods
{
    class ClsObject
    {
        ...
        public static class Consignee
        {
            ...
            public const string QueryCbo = $" SELECT id_consignee AS '{Column.id}', CONCAT(v_nameConsignee, ' | ', id_consignee, ' | (', c_active, ')') AS '{Column.name}', c_active AS '{Column.active}' FROM Pack_Consignee ORDER BY '{Column.name}' ";
        }
        ...
        public static class AgencyTradeUS
        {
            ...
            public const string QueryCbo = $" SELECT id_agencyTrade AS '{Column.id}', CONCAT(v_nameAgency, ' | ', id_agencyTrade, ' | (', c_active, ')') AS '{Column.name}', c_active AS '{Column.active}' FROM Pack_AgencyTrade WHERE c_country = 'US' ORDER BY '{Column.name}' ";
        }
        ...
        public static class AgencyTradeMX
        {
            ...
            public const string QueryCbo = $" SELECT id_agencyTrade AS '{Column.id}', CONCAT(v_nameAgency, ' | ', id_agencyTrade, ' | (', c_active, ')') AS '{Column.name}', c_active AS '{Column.active}' FROM Pack_AgencyTrade WHERE c_country = 'MX' ORDER BY '{Column.name}' ";
        }
        ...
        public static class TransportLine
        {
            ...
            public const string QueryCbo = $" SELECT id_transportLine AS '{Column.id}', CONCAT(v_nameTransportLine, ' | ', id_transportLine, ' | (', c_active, ')') AS '{Column.name}', c_active AS '{Column.active}' FROM Pack_TransportLine ORDER BY '{Column.name}' ";
        }
