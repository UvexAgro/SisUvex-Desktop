...
{
	internal class ClsAsistenciaEmpleado : ClsCatalogos
	{
		FrmAsistenciaEmpleado frm;
		...
		public ClsAsistenciaEmpleado(FrmAsistenciaEmpleado frmAEmpleado)
		{
			this.frm = frmAEmpleado;
		}
